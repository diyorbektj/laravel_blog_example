...
<div class="bg-white w-full h-full px-2 py-2">
    <ul class="flex items-center">
      <li><img class="w-24 h-24 rounded-full border-4 border-green-300" src="{{$chat->user->avatar_path}}" alt=""></li>
      <li class="pl-4">
...
<div class="bg-white w-full h-full px-3 py-4 my-2">
    ...
    <ul class="">
    <form action="{{route('javob.chat',['id' => $chat->id])}}" method="post">
      @csrf
       <!-- <li><img class="w-16 h-16 rounded-full shadow-lg border-3 border-gray-300" src="/images/man.jpg" alt=""></li>-->
       <li class=""><textarea class="border border-gray-300 rounded px-2" name="messege" id="" cols="60" rows="5"></textarea></li>
