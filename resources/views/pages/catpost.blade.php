@extends('app')
@section('title','Admin Panel Powered By Diyorbek')
...
<a href="/post/{{$post->slug}}">
  <div class="px-4 py-4">
    <h1 class="text-xl text-green-500 hover:underline">{{$post->title}}</h1></a>
...
@else
    <div class="p-4 flex justify-center">
        <h1 class="font-bold text-2xl">Bu kategoriyaga doir bironta post topilmadi!</h1>
    </div>
@endif
    </div>
   <div>
